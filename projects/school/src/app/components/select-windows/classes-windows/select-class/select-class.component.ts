...
export class SelectClassComponent implements OnInit {
  ...
  getAccountClass(){
    ...
    this.classesApi.getAccountClass(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.classesApi.getAccountClassNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.classesGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.classesApi.getAccountClassPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.classesGridData = res.docs;
