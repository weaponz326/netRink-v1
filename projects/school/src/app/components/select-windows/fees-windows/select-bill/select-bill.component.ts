...
export class SelectBillComponent implements OnInit {
  ...
  getAccountBill(){
    ...
    this.feesApi.getAccountBill(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.feesApi.getAccountBillNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.billsGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.feesApi.getAccountBillPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.billsGridData = res.docs;
