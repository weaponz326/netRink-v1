...
export class SelectTimetableComponent implements OnInit {
  ...
  getAccountTimetable(){
    ...
    this.timetableApi.getAccountTimetable(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.timetableApi.getAccountTimetableNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.timetableGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.timetableApi.getAccountTimetablePrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.timetableGridData = res.docs;
