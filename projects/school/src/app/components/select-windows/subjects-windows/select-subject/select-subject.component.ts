...
export class SelectSubjectComponent implements OnInit {
  ...
  getAccountSubject(){
    ...
    this.subjectsApi.getAccountSubject(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.subjectsApi.getAccountSubjectNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.subjectsGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.subjectsApi.getAccountSubjectPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.subjectsGridData = res.docs;
