...
export class SelectReportComponent implements OnInit {
  ...
  getAccountReport(){
    ...
    this.reportsApi.getAccountReport(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.reportsApi.getAccountReportNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.reportsGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.reportsApi.getAccountReportPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.reportsGridData = res.docs;
