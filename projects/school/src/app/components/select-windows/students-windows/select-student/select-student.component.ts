...
export class SelectStudentComponent implements OnInit {
  ...
  getAccountStudent(){
    ...
    this.studentsApi.getAccountStudent(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.studentsApi.getAccountStudentNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.studentsGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.studentsApi.getAccountStudentPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.studentsGridData = res.docs;
