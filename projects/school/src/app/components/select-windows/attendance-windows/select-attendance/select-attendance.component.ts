...
export class SelectAttendanceComponent implements OnInit {
  ...
  getAccountAttendance(){
    ...
    this.attendanceApi.getAccountAttendance(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.attendanceApi.getAccountAttendanceNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.attendanceGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.attendanceApi.getAccountAttendancePrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.attendanceGridData = res.docs;
