...
export class SelectTeacherComponent implements OnInit {
  ...
  getAccountTeacher(){
    ...
    this.teachersApi.getAccountTeacher(this.sortParams, 15)
      .then(
        (res: any) => {
          console.log(res);
  ...
  nextPage(e: any){
    ...
    this.teachersApi.getAccountTeacherNext(this.sortParams, 15, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.teachersGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.teachersApi.getAccountTeacherPrev(this.sortParams, 15, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.teachersGridData = res.docs;
