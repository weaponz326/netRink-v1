...
export class AllBillsComponent implements OnInit {
  ...
  getAccountBill(){
    ...
    this.feesApi.getAccountBill(this.sortParams, 20)
      .then(
        (res: any) => {
          console.log(res);
          this.billsGridData = res.docs;
  ...
  nextPage(e: any){
    ...
    this.feesApi.getAccountFeesNext(this.sortParams, 20, this.nextStartAfter)
      .then(
        (res: any) => {
          console.log(res);
          this.billsGridData = res.docs;
  ...
  previousPage(e: any){
    ...
    this.feesApi.getAccountFeesPrev(this.sortParams, 20, this.prevStartAt)
      .then(
        (res: any) => {
          console.log(res);
          this.billsGridData = res.docs;
